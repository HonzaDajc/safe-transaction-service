...
class FantomOracle(PriceOracle):
    ...
    def __init__(self, ethereum_client: EthereumClient, binance_client: BinanceClient):
        """
        :param ethereum_client:
        :param uniswap_factory_address: https://docs.uniswap.io/frontend-integration/connect-to-uniswap#factory-contract
        """

        logger.info('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXxxxxxxxxxxxxxx =%s YYYYYYYYYYYYYYYYYYYYYYYYYYY', env('FANTOM_PRICE_ORACLE', default=None))
        ...
        self.contract = self.w3.eth.contract(address=env('FANTOM_PRICE_ORACLE', default=None), abi=oracle_abi)
...
class PriceService:
    def __init__(self, ethereum_client: EthereumClient, redis: Redis):
        ...
        self.fantom_oracle = FantomOracle(self.ethereum_client, self.binance_client)
        ...
        self.cache_underlying_token = TTLCache(maxsize=2048, ttl=60 * 30)  # 30 minutes of caching
    ...
    def get_underlying_tokens(self, token_address: ChecksumAddress) -> Optional[List[UnderlyingToken]]:
        """
        :param token_address:
        :return: usd value for a given `token_address` using Curve, if not use Coingecko as last resource
        """
